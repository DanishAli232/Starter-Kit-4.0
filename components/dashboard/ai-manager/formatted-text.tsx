      ...
      <div className={cn("prose prose-slate max-w-none", className)}>
        <ReactMarkdown
          ...
          components={{
            ...
            h1: ({ children }) => (
              <h1 className="text-3xl font-bold text-slate-900 mb-2 pb-2 border-b border-slate-200">
                {children}
              </h1>
            ),
            h2: ({ children }) => (
              <h2 className="text-2xl font-semibold text-slate-800 mb-1 mt-6">
                {children}
              </h2>
            ),
            h3: ({ children }) => (
            ...
            // Custom list styling
            ul: ({ children }) => (
              <ul className="space-y-2 mb-2 ml-4">{children}</ul>
            ),
            ol: ({ children }) => (
              <ol className="space-y-2 mb-2 ml-4">{children}</ol>
            ),
            ...
            code: ({ className, children, ...props }) => {
              ...
              return (
                <div className="my-4">
                  ...
                  <pre
                    className={cn(
                      " px-4 rounded-lg overflow-x-auto",
